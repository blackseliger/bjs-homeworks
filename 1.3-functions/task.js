  ...
  if (d < 0) {
   ...
   function getAverageScore(data) {
    ...
    console.log(getAverageScore(
        ...
        //  Здравствуйте! Пожалуйста помогите понять что происходит с 47 строчки до 52. 
        ...
        // как понимаю задание:
        // Первое. создается функция с аргументом data, далее создается вторая функция внутри первое
        // Во второй функции находится среднее число оценок по одному предмету.
        // Далее возращается результат среднего значения или если если нет оценок, возвращается 0.
        // На 46 создается объект, который требуется создать в ТЗ. Дальше с 47 строчки начинаю очень слабо
